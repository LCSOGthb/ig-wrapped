    ...
    <div>
      ...
      {page === "error" && (
        <WrappedContainer>
          ...
          <MutedText>
            We couldn't read your Instagram data export. Please make sure you
      ...
      {page === "possibly_empty" && (
        <WrappedContainer>
          ...
          <MutedText className="mx-auto max-w-xl">
            The Instagram data export you uploaded doesn't contain any data
            about videos watched. This might be because of the country you are
            using Instagram in or your privacy settings in the app. While we can
            still show you some statistics, data about your watch history will
            be blank.
            <br />
      ...
      {page === "text" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            Unfortunately, Wrapped for Instagram does not support this format
            yet as it cannot analyze the data inside.
            <br />
            <br />
      ...
      {page === "unknown_file" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-lg mx-auto">
            ...
            Machine-readable" as the file format when requesting your Instagram
            data export.
            <br />
            If you modified the file, make sure your file has the correct file
            extension.
      ...
      {page === "demo" && (
        <WrappedContainer>
          ...
          <MutedText className="max-w-xl mx-auto">
            You can view a demo of Wrapped for Instagram with sample data if you
            want to.
            <br />
            <strong>
              This is NOT your Wrapped, but a demo of what it could look like.
              <br />
              It does not use your Instagram data export.
            </strong>
            <br />
            <br />
            The data is randomly generated and does not represent any real
            Instagram user - if you want to see your own Wrapped, you can reload
